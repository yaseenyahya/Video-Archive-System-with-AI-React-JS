...
const AllFolderSearchDateRangeModal = forwardRef((props, ref) => {
  ...
  return (
    <div className={classes.mainContainer}>
      <Box className={props.AllFolderSearchDateRangeCalendarButtonClassName} display={"flex"} justifyContent={"center"} alignItems={"center"}>
        <IconButton className={classes.searchIconButton}  onClick={handleOpenPopup}>
          <Typography className={classes.searchIconButtonText}>A</Typography><CalendarTodayIcon className={props.AllFolderSearchDateRangeCalendarIconClassName}/>
        </IconButton>
...
export default AllFolderSearchDateRangeModal;
